...
export function GamePage() {
  ...
  async function runDemo() {
    ...
    setBusy(true);
    const outcome = await playDemo(game.slug, game.name, bet);
    setBusy(false);
